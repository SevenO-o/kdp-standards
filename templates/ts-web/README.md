...
前端采用 KUNPO 青蓝主题，默认浅色并支持记忆深色选择。公共组件与示例用法见 [组件说明](web/components/README.md)，主题入口为 `web/theme.css`。单栏、分栏、列表等结构按业务选择，不要求照搬文本整理样板。当前模板源码为 0.1.4；可用发布组合以可信索引和项目锁为准。
